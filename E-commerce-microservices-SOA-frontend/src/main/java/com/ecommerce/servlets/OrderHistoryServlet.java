...
public class OrderHistoryServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("========================================");
        System.out.println("ORDER HISTORY SERVLET: Fetching orders");
        System.out.println("========================================");
        ...
        try {
            ...
            // Call Customer Service to get orders
            String ordersJson = sendGetRequest(CUSTOMER_SERVICE_URL + customerId + "/orders");
            System.out.println("Orders data received: " + ordersJson);

            // Parse JSON response
            Gson gson = new Gson();
            JsonObject ordersData = gson.fromJson(ordersJson, JsonObject.class);
            ...
            System.err.println("ERROR in OrderHistoryServlet: " + e.getMessage());
            e.printStackTrace();
